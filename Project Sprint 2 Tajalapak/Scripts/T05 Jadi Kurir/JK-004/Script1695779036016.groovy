...
WebUI.clearText(findTestObject('Jadi kurir/input_Merek Kendaraan'))
...
WebUI.uploadFile(findTestObject('Jadi kurir/input_Choose files_uploadFile'), 'C:\\Users\\IRFAN\\Downloads\\KTP.jpg')
...
Merek = webDriver.findElement(By.xpath('//input[@name="merek"]'))

//Mengambil Error Messge
error_message = ((webDriver) as JavascriptExecutor).executeScript('return arguments[0].validationMessage', Merek)
