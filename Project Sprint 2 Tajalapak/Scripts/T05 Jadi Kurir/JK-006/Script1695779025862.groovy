...
WebUI.clearText(findTestObject('Jadi kurir/input_Plat Nomor'), FailureHandling.STOP_ON_FAILURE)
...
Plat = webDriver.findElement(By.xpath('//input[@name="plat_nomor"]'))

//Mengambil Error Messge
error_message = ((webDriver) as JavascriptExecutor).executeScript('return arguments[0].validationMessage', Plat)
