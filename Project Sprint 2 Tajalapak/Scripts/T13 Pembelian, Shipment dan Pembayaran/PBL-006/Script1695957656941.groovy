...
WebUI.clearText(findTestObject('checkout/input_Alamat Kirim'))
...
//Mengambil Objek inputan alamat
field_alamat = webDriver.findElement(By.xpath('//input[@name="alamat"]'))

//Mengambil Error Messge
error_message = ((webDriver) as JavascriptExecutor).executeScript('return arguments[0].validationMessage', field_alamat)
