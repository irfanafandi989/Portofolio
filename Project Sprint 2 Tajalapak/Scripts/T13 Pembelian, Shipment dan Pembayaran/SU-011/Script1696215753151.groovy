...
HashMap<String, Object> data = WebUI.callTestCase(findTestCase('T13 Pembelian, Shipment dan Pembayaran/SA-004'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('verifikasi/Sedang Dikirim'))

WebUI.verifyElementPresent(findTestObject('verifikasi/Notifikasi angka'), 1)

dikirim = WebUI.getText(findTestObject('verifikasi/status Dikirim di user'), FailureHandling.STOP_ON_FAILURE)

statusDikirim = data.get('statuskirim')

assert dikirim == statusDikirim
