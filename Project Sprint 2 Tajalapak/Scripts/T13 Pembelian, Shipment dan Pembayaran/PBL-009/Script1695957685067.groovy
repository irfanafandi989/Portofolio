...
HashMap<String, Object> data = WebUI.callTestCase(findTestCase('T13 Pembelian, Shipment dan Pembayaran/PBL-002'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('voucher/input kupon'), 'kupon99')

WebUI.click(findTestObject('voucher/button kupon'))

WebUI.verifyElementText(findTestObject('voucher/Maaf, Kode Kupon  Voucher Tidak ditemukan'), 'Maaf, Kode Kupon / Voucher Tidak ditemukan.')

WebUI.click(findTestObject('hapus barang/button_Kembali'))

WebUI.mouseOver(findTestObject('beli barang/keranjang'))

WebUI.click(findTestObject('hapus barang/buttom x'))

WebUI.click(findTestObject('hapus barang/button_Hapus Barang'))
