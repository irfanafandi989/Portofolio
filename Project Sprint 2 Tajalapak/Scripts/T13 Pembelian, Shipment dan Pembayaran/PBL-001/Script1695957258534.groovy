...
WebUI.callTestCase(findTestCase('T13 Pembelian, Shipment dan Pembayaran/LU-001'), [('username') : 'irfanafandi'
        , ('password') : '12345irfan'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('beli barang/Tambah Keranjang busana wanita'))

WebUI.verifyElementPresent(findTestObject('checkout/Notifikasi keranjang'), 1)
