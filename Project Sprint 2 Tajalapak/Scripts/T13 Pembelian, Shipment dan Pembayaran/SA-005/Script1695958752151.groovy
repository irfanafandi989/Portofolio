...
WebUI.click(findTestObject('admin/Penjualan ke konsumen/Selesai'),FailureHandling.CONTINUE_ON_FAILURE)
...
selesaiAdmin = WebUI.getText(findTestObject('admin/Selesai'))

data.put('statusSelesai', selesaiAdmin)
