...
HashMap<String, Object> data = WebUI.callTestCase(findTestCase('T13 Pembelian, Shipment dan Pembayaran/SA-004'), 
...
dikirim = WebUI.getText(findTestObject('Object Repository/Traking Order/status traking/Status traking Dikirim'))
