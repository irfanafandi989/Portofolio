...
HashMap<String, Object> data = WebUI.callTestCase(findTestCase('T13 Pembelian, Shipment dan Pembayaran/SA-005'), 
...
selesai = WebUI.getText(findTestObject('Object Repository/Traking Order/status traking/status traking selesai'))
