...
HashMap<String, Object> data = WebUI.callTestCase(findTestCase('T13 Pembelian, Shipment dan Pembayaran/PBL-001'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyTextPresent('Silakan pilih warna dan ukuran produk', false)
