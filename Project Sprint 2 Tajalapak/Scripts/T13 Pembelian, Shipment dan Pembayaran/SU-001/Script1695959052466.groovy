...
HashMap<String, Object> data = WebUI.callTestCase(findTestCase('T13 Pembelian, Shipment dan Pembayaran/PBY-002'), 
...
WebUI.verifyElementPresent(findTestObject('Traking Order/status traking/Status Konfirmasi'), 0)
