...
WebUI.clearText(findTestObject('Konfirmasi pesanan shop/input_Total TagihanTransfer_b'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Konfirmasi pesanan shop/input_Total TagihanTransfer_b'), '-1')
...
WebUI.verifyTextPresent('inputkan harus angka sesuai', false)
