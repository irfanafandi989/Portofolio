...
WebUI.clearText(findTestObject('Traking Order/input_No Pesanan_a'), FailureHandling.STOP_ON_FAILURE)

WebUI.clearText(findTestObject('Traking Order/input_Alamat E-mail_form-control'), FailureHandling.STOP_ON_FAILURE)
...
//Mengambil Objek inputan tracking
field_tracking = webDriver.findElement(By.xpath('(//input[@name="a"])[3]'))

//Mengambil Error Messge
error_message = ((webDriver) as JavascriptExecutor).executeScript('return arguments[0].validationMessage', field_tracking)
