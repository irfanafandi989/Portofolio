...
//Mengambil Objek inputan jumlah
field_jumlah = webDriver.findElement(By.xpath('//input[@name="dd"]'))

//Mengambil Error Messge
error_message = ((webDriver) as JavascriptExecutor).executeScript('return arguments[0].validationMessage', field_jumlah)
