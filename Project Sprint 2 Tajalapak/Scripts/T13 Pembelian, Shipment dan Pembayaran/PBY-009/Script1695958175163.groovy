...
field_upload = webDriver.findElement(By.xpath('//input[@name="f"]'))

//Mengambil Error Messge
error_message = ((webDriver) as JavascriptExecutor).executeScript('return arguments[0].validationMessage', field_upload)

println(error_message)

//verifikasi apakah error message sesuai
assert error_message == 'Please select a file.'
