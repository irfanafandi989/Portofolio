...
WebUI.click(findTestObject('shipment/a_Pending'),  FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.verifyElementText(findTestObject('PROSES PENJUALAN/Pending'), 'Pending')

pending = WebUI.getText(findTestObject('PROSES PENJUALAN/Pending'))
