...
statusPembelian = WebUI.getText(findTestObject('verifikasi/Status pending di pembelian'))

data.put('statusPem', statusPembelian)
...
WebUI.click(findTestObject('QRIS/a_Lihat Metode Pembayaran Lainnya'))

WebUI.switchToWindowIndex(1)

WebUI.verifyElementPresent(findTestObject('QRIS/ipaymu'), 0)

//WebUI.click(findTestObject('QRIS/input_Biaya Proteksi_insuranceCheck'))
//
//WebUI.click(findTestObject('QRIS/QRIS'))
//
//WebUI.setText(findTestObject('QRIS/input_Nama_name'), 'irfan')
//
//WebUI.setText(findTestObject('QRIS/input_No. HPTelepon_phone'), '081212121212')
//
//WebUI.setText(findTestObject('QRIS/input_Email_email'), 'fan@gmail.com')
//
//WebUI.click(findTestObject('QRIS/input_Anda bersedia menggunakan email untuk mendaftar akun iPaymu_check_register_ipaymu'))
//
//WebUI.click(findTestObject('keranjang/konfirmasi/button_BAYAR SEKARANG'))
return data
