...
HashMap<String, Object> data = WebUI.callTestCase(findTestCase('T13 Pembelian, Shipment dan Pembayaran/SA-006'), [:], FailureHandling.STOP_ON_FAILURE)
...
Pending = WebUI.getText(findTestObject('Beli tanpa akun/Pending'))

// verifikasi status
statusPembayaran = data.get('statusPending')

assert Pending == statusPembayaran
