...
WebUI.click(findTestObject('admin/Penjualan ke konsumen/Dikirim'), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.verifyElementText(findTestObject('PROSES PENJUALAN/Dikirim'), 'Dikirim')

dikirim = WebUI.getText(findTestObject('PROSES PENJUALAN/Dikirim'))

data.put('statuskirim', dikirim)
