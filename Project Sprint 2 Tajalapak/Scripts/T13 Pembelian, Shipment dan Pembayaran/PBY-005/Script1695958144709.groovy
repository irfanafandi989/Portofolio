...
HashMap<String, Object> data = WebUI.callTestCase(findTestCase('T13 Pembelian, Shipment dan Pembayaran/PBY-001'), 
...
WebUI.clearText(findTestObject('Konfirmasi pesanan shop/input_Nama Pengirim_d'), FailureHandling.STOP_ON_FAILURE)

WebUI.uploadFile(findTestObject('Konfirmasi pesanan shop/input_Upload Bukti Transfer_f'), 'C:\\Users\\IRFAN\\Downloads\\Berkas2.pdf')
...
//Mengambil Objek inputan total tagihan
field_tagihan = webDriver.findElement(By.xpath('//input[@name="d"]'))

//Mengambil Error Messge
error_message = ((webDriver) as JavascriptExecutor).executeScript('return arguments[0].validationMessage', field_tagihan)
