...
WebUI.click(findTestObject('Sorting/TH Last Name 2'))
WebUI.click(findTestObject('Sorting/TH Last Name 2'))

List<WebElement> dataList = WebUI.findWebElements(findTestObject('Object Repository/Sorting/Data List Last Name 2'),10)
