...
WebUI.setText(findTestObject('Make Appointment/input Visit Date (Required)'), '20/05/2023')

WebUI.setText(findTestObject('Make Appointment/Text Area Comment'), 'halo bang jagoo')
