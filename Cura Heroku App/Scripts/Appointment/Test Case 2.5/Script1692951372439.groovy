...
WebUI.check(findTestObject('Make Appointment/Radio None programs'))

WebUI.setText(findTestObject('Make Appointment/input Visit Date (Required)'), visit_date)

WebUI.setText(findTestObject('Make Appointment/Text Area Comment'), '')

WebUI.click(findTestObject('Make Appointment/button Book Appointment'))

WebUI.verifyElementPresent(findTestObject('Make Appointment/Tittle Appointment Confirmation'), 0)
