...
WebUI.callTestCase(findTestCase('Login/Test Case 1.1 (Manual)'), [:], FailureHandling.STOP_ON_FAILURE)
...
if (hospital_readmission.toString().equalsIgnoreCase('yes')) {
    WebUI.check(findTestObject('Page_CURA Healthcare Service/NO for hospital readmission'))
}
...
WebUI.setText(findTestObject('Make Appointment/Text Area Comment'), 'Hello World')
...
hasilReadmission = WebUI.getText(findTestObject('Make Appointment/Hasil NO hospital readmission'))
