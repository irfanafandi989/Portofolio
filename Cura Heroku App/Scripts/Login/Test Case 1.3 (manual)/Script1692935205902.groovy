...
WebUI.setText(findTestObject('Login/Input Password'), '')

WebUI.click(findTestObject('Login/Button Login'))

WebUI.verifyElementText(findTestObject('Login/massage error tidak ada password'), 'Login failed! Please enter the password.')
