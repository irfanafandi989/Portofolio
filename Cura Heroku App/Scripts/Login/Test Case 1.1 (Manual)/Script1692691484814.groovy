...
WebUI.setText(findTestObject('Login/Input Username'), 'John Doe')

WebUI.setEncryptedText(findTestObject('Login/Input Password'), 'g3/DOGG74jC3Flrr3yH+3D/yKbOqqUNM')

WebUI.click(findTestObject('Login/Button Login'))

WebUI.verifyElementPresent(findTestObject('Login/Tittle Make Appointment'), 10)
