...
WebUI.setText(findTestObject('Checkout/input firstName'), 'joko')

WebUI.setText(findTestObject('Checkout/input postalCode'), '12345')

WebUI.click(findTestObject('Checkout/input continue checkout'))

WebUI.verifyElementText(findTestObject('Checkout/Massage Error Last Name is required'), 'Then will be show error message "Last Name Required')
