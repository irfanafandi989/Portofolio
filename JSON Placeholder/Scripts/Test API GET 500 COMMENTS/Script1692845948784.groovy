...
response = WS.sendRequest(findTestObject('Object Repository/GET 500 COMMENTS API'))

WS.verifyResponseStatusCode(response, 200)

WS.verifyElementsCount(response, "" , 500)

for (i=0; i < 5; i++) {

PostId = WS.getElementPropertyValue(response, "["+ i +"]")
