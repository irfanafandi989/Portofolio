...
//verifikasi id postnya sesuai
WS.verifyElementPropertyValue(response, "id", PostId)

//verifikasi data lain tidak null atau kosong

userId =  WS.getElementPropertyValue(response, "userId");
