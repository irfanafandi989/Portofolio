...
WebUI.setText(findTestObject('Edit Data konsumen/input tanggal lahir/input_Tanggal Lahir'), '0000-00-00')

WebUI.click(findTestObject('Edit Data konsumen/button_Update'))

WebUI.verifyTextPresent('Tanggal Lahir tidak Valid', false)
