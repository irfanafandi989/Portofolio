...
WebUI.setText(findTestObject('file baru/search'), 'udin123')
...
WebUI.setText(findTestObject('Edit Data konsumen/input_Nama Lengkap'), '//')

WebUI.click(findTestObject('Edit Data konsumen/button_Update'))

WebUI.verifyTextPresent('Nama tidak boleh menggunakan Symbol', false)
