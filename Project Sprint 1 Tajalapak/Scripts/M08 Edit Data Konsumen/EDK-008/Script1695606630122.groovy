...
WebUI.setText(findTestObject('Edit Data konsumen/Input Alamat email/input Alamat Email'), 'testing')
...
//Mengambil Objek inputan email dulu
field_email = webDriver.findElement(By.xpath('//input[@name="c"]'))

//Mengambil Error Messge
error_message = ((webDriver) as JavascriptExecutor).executeScript('return arguments[0].validationMessage', field_email)
