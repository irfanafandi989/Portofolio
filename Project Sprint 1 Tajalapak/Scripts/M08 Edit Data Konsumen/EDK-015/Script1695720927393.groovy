...
WebUI.clearText(findTestObject('Edit Data konsumen/Input Alamat email/input Alamat Email'), FailureHandling.STOP_ON_FAILURE)

WebUI.clearText(findTestObject('Edit Data konsumen/Input no Hp/input No Hp'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.clearText(findTestObject('Edit Data konsumen/Alamat/input_Alamat'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Edit Data konsumen/button_Update'))

WebUI.verifyTextPresent('This is a required field.', false)
